...
use houses_stake::cpi::accounts::Stake as CpiStake;
use houses_stake::types::{StakePda, Data};
use houses_stake::program::HousesStake;

use crate::types::*;

pub fn stake(ctx: Context<Stake>, email: String, amount: u64
) -> Result<()> {
    ...
    let cpi_accounts = CpiStake {
        ...
        user_token_account: ctx.accounts.user_pda_token_account.to_account_info(),
